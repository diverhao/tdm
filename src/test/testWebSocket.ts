...
const client = new WsPvClient(workerData);
...
//     }
//     wsPvClient.wsPut("loc://arr1", arr1);
// }, 1000);
...
// 		wsPvClient.wsPut("loc://arr1Avg", num);
// 		wsPvClient.wsPut("loc://arr1AvgX", [0, value.length]);
// 		wsPvClient.wsPut("loc://arr1AvgY", [num, num]);
// 		wsPvClient.wsPut("loc://arr1AvgYPoint", num);
// 	}
// });


const dataOffset = (data: Record<string, any>) => {
...
// wsClient.wsPut("loc://selectImg", 1)
...
// 		const fn = fns[currentImg];
// 		const img = fs.readFileSync(fn);
// 		const str = img.toString("base64");

// 		wsClient.wsPut("loc://img1", str);
// 	}
// });
