...
export class FontsData {
    ...
    static g_fonts: Record<string, Record<string, FontFace>> = {
        ...
        Tinos: {
            Regular: new FontFace("Tinos", `url(${this.basePath}/webpack/resources/fonts//Tinos/Tinos-Regular.ttf)`, { style: "normal", weight: "normal" }),
            Bold: new FontFace("Tinos", `url(${this.basePath}/webpack/resources/fonts//Tinos/Tinos-Bold.ttf)`, { style: "normal", weight: "bold" }),
            Italic: new FontFace("Tinos", `url(${this.basePath}/webpack/resources/fonts//Tinos/Tinos-Italic.ttf)`, { style: "italic", weight: "normal" }),
        },
        "Courier Prime": {
