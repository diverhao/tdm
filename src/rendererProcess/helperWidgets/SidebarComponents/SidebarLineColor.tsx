 ...
 */
export class SidebarLineColor extends SidebarComponent {
	...
	_Element = () => {
		return (
			<Collapsible
				rgbColorStr={this.getMainWidget().getText()["lineColor"]}
	...
	updateWidget = (event: any, propertyValue: number | string | number[] | string[] | boolean | undefined) => {
		...
		const oldVal = this.getText()["lineColor"];
		if (newVal === oldVal) {
			return;
		} else {
			this.getText()["lineColor"] = newVal;
		}
