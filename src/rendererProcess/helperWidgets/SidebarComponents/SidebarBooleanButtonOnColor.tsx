 ...
 */
export class SidebarBooleanButtonOnColor extends SidebarComponent {
	...
	_Element = () => {
		...
		return (
			<Collapsible
				rgbColorStr={this.getMainWidget().getText()["onColor"]}
	...
	updateWidget = (event: any, propertyValue: number | string | number[] | string[] | boolean | undefined) => {
		...
		const oldVal = this.getText()["onColor"];
		if (newVal === oldVal) {
			return;
		} else {
			this.getText()["onColor"] = newVal;
		}
