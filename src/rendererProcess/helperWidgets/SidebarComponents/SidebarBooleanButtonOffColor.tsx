 ...
 */
export class SidebarBooleanButtonOffColor extends SidebarComponent {
	...
	_Element = () => {
		...
		return (
			<Collapsible
				rgbColorStr={this.getMainWidget().getText()["offColor"]}
	...
	updateWidget = (event: any, propertyValue: number | string | number[] | string[] | boolean | undefined) => {
		...
		const oldVal = this.getText()["offColor"];
		if (newVal === oldVal) {
			return;
		} else {
			this.getText()["offColor"] = newVal;
		}
