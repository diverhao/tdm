 ...
 */
export class SidebarFillColorMajor extends SidebarComponent {
	...
	_Element = () => {
		return (
			<Collapsible
				rgbColorStr={this.getMainWidget().getText()["fillColorMajor"]}
	...
	updateWidget = (event: any, propertyValue: number | string | number[] | string[] | boolean | undefined) => {
		...
		const oldVal = this.getText()["fillColorMajor"];
		if (newVal === oldVal) {
			return;
		} else {
			this.getText()["fillColorMajor"] = newVal;
		}
