...
export class SidebarDiscreteStateItem {
    ...
    constructor(items: SidebarDiscreteStateItems, index: number) {
        this._items = items;
        this._index = index;
    ...
    getMainWidget = () => {
        return this.getItems().getMainWidget() as DiscreteStateWidget;
    };
    ...
    _Element = () => {
        ...
        // true or undefined
        const useItemColor = (this.getItems().getMainWidget().getSidebar() as any).useItemColor;
        ...
        return (
            <this._BlockBody>
                    ...
                    <form
                        onSubmit={(event: React.FormEvent<HTMLFormElement>) => {
                            ...
                            if (!isNaN(itemValueNum)) {
                                this.updateWidgetValue(event, itemValueNum);
                            } else {
                                setItemValue(orig);
                            }
                ...
                <div
                    style={{
                        display: useItemColor === true ? "inline-flex" : "none",
                        flexDirection: "row",
                        width: "100%",
                        justifyContent: "space-between",
                        alignItems: "center",
    ...
    updateWidgetMoveUpItem = (event: any) => {
        ...
        const itemColor = mainWidget.getItemColors()[thisIndex];
        mainWidget.getItemColors().splice(thisIndex, 1);
        mainWidget.getItemColors().splice(thisIndex - 1, 0, itemColor);
