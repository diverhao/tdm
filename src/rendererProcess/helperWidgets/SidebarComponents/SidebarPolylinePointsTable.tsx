            ...
            <form
                onSubmit={(event: React.FormEvent<HTMLFormElement>) => {
                    ...
                    if (isNaN(valNum)) {
                        ...
                        this.updateWidgetCoordinate(event, valNum, dataArray, index, direction)
                    }
            ...
            >
                <input
                    ...
                    onBlur={(event: any) => {
                        ...
                        if (dataArray[index] * size !== parseInt(val)) {
                            setVal(`${dataArray[index] * size}`);
                        }
                        const mainWidget = this.getSidebar().getMainWidget();
                        if (mainWidget instanceof Polyline) {
                            mainWidget.selectedPointIndex = -1;
                        }
                    ...
                    onFocus={(event: any) => {
                        ...
                        const mainWidget = this.getSidebar().getMainWidget();
                        if (mainWidget instanceof Polyline) {
                            mainWidget.selectedPointIndex = index;
                        }
                        g_widgets1.addToForceUpdateWidgets(this.getWidgetKey());
                        g_widgets1.addToForceUpdateWidgets("GroupSelection2");
