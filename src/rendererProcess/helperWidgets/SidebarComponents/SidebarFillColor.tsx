 ...
 */
export class SidebarFillColor extends SidebarComponent {
	...
	_Element = () => {
		return (
			<Collapsible
				rgbColorStr={this.getMainWidget().getText()["fillColor"]}
	...
	updateWidget = (event: any, propertyValue: number | string | number[] | string[] | boolean | undefined) => {
		...
		const oldVal = this.getText()["fillColor"];
		if (newVal === oldVal) {
			return;
		} else {
			this.getText()["fillColor"] = newVal;
		}
