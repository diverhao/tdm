 ...
 */
export class SidebarTextColor extends SidebarComponent {
	...
	_Element = () => {
		return (
			<Collapsible
				rgbColorStr={this.getMainWidget().getStyle().color}
	...
	updateWidget = (event: any, propertyValue: number | string | number[] | string[] | boolean | undefined) => {
		...
		const oldVal = this.getStyle()["color"];
		if (newVal === oldVal) {
			return;
		} else {
			this.getStyle()["color"] = newVal;
		}
