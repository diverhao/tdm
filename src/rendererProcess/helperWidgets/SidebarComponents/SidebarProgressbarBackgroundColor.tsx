 ...
 */
export class SidebarProgressBarBackgroundColor extends SidebarComponent {
	...
	_Element = () => {
		return (
			<Collapsible
				rgbColorStr={this.getMainWidget().getText()["backgroundColor"]}
	...
	updateWidget = (event: any, propertyValue: number | string | number[] | string[] | boolean | undefined) => {
		...
		const oldVal = this.getText()["backgroundColor"];
		if (newVal === oldVal) {
			return;
		} else {
			this.getText()["backgroundColor"] = newVal;
		}
