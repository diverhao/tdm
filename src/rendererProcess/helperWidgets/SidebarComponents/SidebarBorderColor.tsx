 ...
 */
export class SidebarBorderColor extends SidebarComponent {
	...
	_Element = () => {
		...
		return (
			<Collapsible
				rgbColorStr={this.getMainWidget().getStyle().borderColor}
	...
	updateWidget = (event: any, propertyValue: number | string | number[] | string[] | boolean | undefined) => {
		...
		const oldVal = this.getStyle()["borderColor"];
		if (newVal === oldVal) {
			return;
		} else {
			this.getStyle()["borderColor"] = newVal;
		}
