...
export class RuleMajorSeverityColor extends RuleComponent {
	...
	getWidgetValue = () => {
		...
		return text["majorSeverityColor"];
	};
	...
	evaluatePropertyValue = (input: string): { text: { majorSeverityColor?: string } } => {
		return {
			text: {
				majorSeverityColor: input,
			},
		};
	};
}
