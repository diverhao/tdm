...
export class RuleMinorSeverityColor extends RuleComponent {
	...
	getWidgetValue = () => {
		...
		return text["minorSeverityColor"];
	};
	...
	evaluatePropertyValue = (input: string): { text: { minorSeverityColor?: string } } => {
		return {
			text: {
				minorSeverityColor: input,
			},
		};
	};
}
