...
export class RuleChoiceButtonUnselectedBackgroundColor extends RuleComponent {
	...
	getWidgetValue = () => {
		...
		return text["unselectedBackgroundColor"];
	};
	...
	ElementPropertyValue = () => {
		...
		return (
			<Collapsible
				...
				title={"is"}
				eventName={"unselectedBackground-color"}
			/>
		);
	};
	...
	evaluatePropertyValue = (input: string): { text: { unselectedBackgroundColor?: string } } => {
		return {
			text: {
				unselectedBackgroundColor: input,
			},
		};
	};
}
