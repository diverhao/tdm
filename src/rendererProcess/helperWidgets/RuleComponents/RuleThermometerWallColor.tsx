...
export class RuleThermometerWallColor extends RuleComponent {
	...
	evaluatePropertyValue = (input: string): { text: { wallColor?: string } } => {
		return {
			text: {
				wallColor: input,
			},
