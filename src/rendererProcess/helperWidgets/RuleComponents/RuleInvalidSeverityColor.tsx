...
export class RuleInvalidSeverityColor extends RuleComponent {
	...
	getWidgetValue = () => {
		...
		return text["invalidSeverityColor"];
	};
	...
	ElementPropertyValue = () => {
		...
		return (
			<Collapsible
				...
				title={"is"}
				eventName={"majorSeverityColor-color"}
			/>
		);
	};
	...
	evaluatePropertyValue = (input: string): { text: { invalidSeverityColor?: string } } => {
		return {
			text: {
				invalidSeverityColor: input,
			},
		};
	};
}
