...
export class RuleChoiceButtonSelectedBackgroundColor extends RuleComponent {
	...
	getWidgetValue = () => {
		...
		return text["selectedBackgroundColor"];
	};
	...
	ElementPropertyValue = () => {
		...
		return (
			<Collapsible
				...
				title={"is"}
				eventName={"selectedBackground-color"}
			/>
		);
	};
	...
	evaluatePropertyValue = (input: string): { text: { selectedBackgroundColor?: string } } => {
		return {
			text: {
				selectedBackgroundColor: input,
			},
		};
	};
}
