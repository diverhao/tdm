...
export class RuleLEDFallbackColor extends RuleComponent {
	...
	evaluatePropertyValue = (input: string): { text: { fallbackColor?: string } } => {
		return {
			text: {
				fallbackColor: input,
			},
