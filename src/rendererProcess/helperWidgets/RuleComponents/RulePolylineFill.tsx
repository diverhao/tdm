...
export class RulePolylineFill extends RuleComponent {
	...
	ElementPropertyValue = () => {
		// "true" or "false"
		const [fill, setFill] = React.useState(`${this.getRule().getPropertyValue()}`);
	...
	evaluatePropertyValue = (input: string): { text: { fill?: boolean } } => {
		try {
