/**
 * Color map lookup tables and functions for the Image widget.
 *
 * Each color map consists of a 256x3 flat array of RGB values and a
 * lookup function that maps a 0-255 value to an [R, G, B] triple.
 *
 * The arrays were generated with matplotlib:
 * ```python
...
export type ColorMapFunc = (value: number) => [number, number, number];



export const jetColorMapArray: number[] = [
    0, 0, 127,
    0, 0, 132,
    0, 0, 136,
    0, 0, 141,
...
export const jetColorMap: ColorMapFunc = (value: number) => {
    // value is 0–255
    ...
    return (
        [
            jetColorMapArray[idx],
            jetColorMapArray[idx + 1],
            jetColorMapArray[idx + 2],
        ]
    )

}

export const hotColorMapArray: number[] = [
    10, 0, 0,
    13, 0, 0,
    15, 0, 0,
    18, 0, 0,
...
export const hotColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.floor(value) * 3;
    return (
        [
            hotColorMapArray[idx],
            hotColorMapArray[idx + 1],
            hotColorMapArray[idx + 2],
        ]
    )
}

export const parulaColorMapArray: number[] = [
...
export const parulaColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.floor(value) * 3;
    return (
        [
            parulaColorMapArray[idx],
            parulaColorMapArray[idx + 1],
            parulaColorMapArray[idx + 2],
        ]
    )
}

export const coolColorMapArray: number[] = [
    0, 255, 255,
    1, 254, 255,
    2, 253, 255,
    3, 252, 255,
...
export const coolColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.floor(value) * 3;
    return (
        [
            coolColorMapArray[idx],
            coolColorMapArray[idx + 1],
            coolColorMapArray[idx + 2],
        ]
    )
}

export const grayColorMapArray: number[] = [
...
export const grayColorMap: ColorMapFunc = (value: number) => {
    // value is 0–255
    const idx = Math.floor(value) * 3;
    return (
        [
            grayColorMapArray[idx],
            grayColorMapArray[idx + 1],
            grayColorMapArray[idx + 2],
        ]
    )
}


export const viridisColorMapArray: number[] = [
    68, 1, 84,
    68, 2, 85,
    68, 3, 87,
    69, 5, 88,
...
export const viridisColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.round(value) * 3;
    return (
        [
            viridisColorMapArray[idx],
            viridisColorMapArray[idx + 1],
            viridisColorMapArray[idx + 2],
        ]
    )
}
export const coolWarmColorMapArray: number[] = [
    58, 76, 192,
    59, 77, 193,
    60, 79, 195,
    62, 81, 196,
...
export const coolWarmColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.round(value) * 3;
    return (
        [
            coolWarmColorMapArray[idx],
            coolWarmColorMapArray[idx + 1],
            coolWarmColorMapArray[idx + 2],
        ]
    )
}

export const seimsicColorMapArray: number[] = [
    0, 0, 76,
    0, 0, 79,
    0, 0, 82,
    0, 0, 84,
...
export const seimsicColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.round(value) * 3;
    return (
        [
            seimsicColorMapArray[idx],
            seimsicColorMapArray[idx + 1],
            seimsicColorMapArray[idx + 2],
        ]
    )
}


export const plasmaColorMapArray: number[] = [
    12, 7, 134,
    16, 7, 135,
    19, 6, 137,
    21, 6, 138,
...
export const plasmaColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.round(value) * 3;
    return (
        [
            plasmaColorMapArray[idx],
            plasmaColorMapArray[idx + 1],
            plasmaColorMapArray[idx + 2],
        ]
    )
}

export const infernoColorMapArray: number[] = [
    0, 0, 3,
    0, 0, 4,
    0, 0, 6,
    1, 0, 7,
...
export const infernoColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.round(value) * 3;
    return (
        [
            infernoColorMapArray[idx],
            infernoColorMapArray[idx + 1],
            infernoColorMapArray[idx + 2],
        ]
    )
}
...
export const magmaColorMapArray: number[] = [
    0, 0, 3,
    0, 0, 4,
    0, 0, 6,
    1, 0, 7,
...
export const magmaColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.round(value) * 3;
    return (
        [
            magmaColorMapArray[idx],
            magmaColorMapArray[idx + 1],
            magmaColorMapArray[idx + 2],
        ]
    )
}

export const cividisColorMapArray: number[] = [
    0, 34, 77,
    0, 35, 79,
    0, 35, 80,
    0, 36, 82,
...
export const cividisColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.round(value) * 3;
    return (
        [
            cividisColorMapArray[idx],
            cividisColorMapArray[idx + 1],
            cividisColorMapArray[idx + 2],
        ]
    )
}

export const spectralColorMapArray: number[] = [
    158, 1, 66,
    160, 3, 66,
    162, 5, 67,
    164, 8, 67,
...
export const spectralColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.round(value) * 3;
    return (
        [
            spectralColorMapArray[idx],
            spectralColorMapArray[idx + 1],
            spectralColorMapArray[idx + 2],
        ]
    )
}

export const nipySpectralColorMapArray: number[] = [
    0, 0, 0,
    9, 0, 10,
    18, 0, 21,
    28, 0, 31,
...
export const nipySpectralColorMap: ColorMapFunc = (value: number) => {
    const idx = Math.round(value) * 3;
    return (
        [
            nipySpectralColorMapArray[idx],
            nipySpectralColorMapArray[idx + 1],
            nipySpectralColorMapArray[idx + 2],
        ]
    )
}

export const colorMapFunctions: Record<string, ColorMapFunc> = {
    parula: parulaColorMap,
    viridis: viridisColorMap,
    gray: grayColorMap,
    jet: jetColorMap,
    seimsic: seimsicColorMap,
    hot: hotColorMap,
    cool: coolColorMap,
    ...
    spectral: spectralColorMap,
    "nipy spectral": nipySpectralColorMap,
}

export const colorMapArrays: Record<string, number[]> = {
    parula: parulaColorMapArray,
    viridis: viridisColorMapArray,
    gray: grayColorMapArray,
    jet: jetColorMapArray,
    seimsic: seimsicColorMapArray,
    hot: hotColorMapArray,
    cool: coolColorMapArray,
    coolwarm: coolWarmColorMapArray,
    plasma: plasmaColorMapArray,
    inferno: infernoColorMapArray,
    magma: magmaColorMapArray,
    cividis: cividisColorMapArray,
    spectral: spectralColorMapArray,
    "nipy spectral": nipySpectralColorMapArray,
}
