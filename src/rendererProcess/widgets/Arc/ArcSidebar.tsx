...
export class ArcSidebar extends BaseWidgetSidebar {
    ...
    getSidebarArcAngleStart = () => {
        return this._sidebarArcAngleStart;
    };

    getSidebarArcAngleRange = () => {
        return this._sidebarArcAngleRange;
    };

    getSidebarArcShowRadius = () => {
        return this._sidebarArcShowRadius;
    };
