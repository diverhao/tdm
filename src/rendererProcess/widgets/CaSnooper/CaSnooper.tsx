...
export class CaSnooper extends BaseWidget {
    ...
    constructor(widgetTdl: type_CaSnooper_tdl) {
        ...
        this._table = new Table([defaultFontSize * 4, defaultFontSize * 16, defaultFontSize * 20, defaultFontSize * 11, defaultFontSize * 8], this);
    ...
    _ElementAreaRaw = (): React.JSX.Element => {
        return (
            ...
            >
                <this._ElementCaSnooper></this._ElementCaSnooper>
            </div>
        );
    };
        ...
        return (
            <div style={{
                ...
                <div style={{
                    ...
                    The CA Snooper is listening to UDP port {this.getAllText()["EPICS_CA_SERVER_PORT"]} for any package that has a 0x0006 header (CA_PROTO_SEARCH).
