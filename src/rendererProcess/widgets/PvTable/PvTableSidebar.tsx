...
export class PvTableSidebar extends BaseWidgetSidebar {
    ...
    _sidebarPvTableProperties: SidebarPvTableProperties;
    constructor(pvTable: PvTable) {
        super(pvTable);
        this._sidebarPvTableProperties = new SidebarPvTableProperties(this);
    }
    ...
    _Element = (): React.JSX.Element => {
        ...
        return (
            ...
            >
                ...
                {this.getSidebarChannelNames().getElement()}
                {this.getSidebarPvTableProperties().getElement()}
                <this._BlockBody>
