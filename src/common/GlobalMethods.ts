...
// export const generateDisplayWindowWebHtml = (option: {basePath: string, displayWindowId: string}) => {
...
// 		<!-- come with absolute path -->
// 		<!-- it is recommended to use for production -->
// 		<script type="module" src="${basePath}/DisplayWindowClient.js"></script>
...
// 			if (file !== null) {
// 				// refresh the webpage
// 				// (1) tell the main process to create DisplayWindowAgent for this page
// 				//     then we obtain the display window ID
// 				// (2) update page address with new display window ID, remove the
// 				//     "file" query
// 				// (3) use the display window ID and websocket IPC server port to create
// 				//     DisplayWindowClient
...
// 							// (2)
// 							window.history.replaceState({}, "", `DisplayWindow.html?displayWindowId=${displayWindowId}`);
// 							// (3)
// 							new window.DisplayWindowClientClass(displayWindowId, parseInt(ipcServerPort));
// 						});
// 				}
// 			} else {
// 				// open a webpage normally
//                 // same as http port
//                 const ipcServerPort = window.location.port;
//                 new window.DisplayWindowClientClass(displayWindowId, parseInt(ipcServerPort));
// 			}
// 		</script>
// 	</body>
