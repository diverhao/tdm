...
import { defaultFontSize, defaultFontFamily, defaultFontStyle, defaultFontWeight } from "../GlobalVariables";
...
export const type_Canvas_style_tdl_schema = {
    position: "string",
    display: "string",
    left: "number",
    top: "number",
...
export const type_Canvas_tdl_schema = {
    type: "string",
    widgetKey: "string",
    key: "string",
