...
cp ${TDM_ROOT}/src/mainProcess/windows/MainWindow/MainWindow.html ${TDM_ROOT}/dist/webpack/MainWindow.html
cp ${TDM_ROOT}/src/mainProcess/windows/DisplayWindow/DisplayWindow.html ${TDM_ROOT}/dist/webpack/DisplayWindow.html
cp ${TDM_ROOT}/src/mainProcess/windows/HelpWindow/HelpWindow.html ${TDM_ROOT}/dist/webpack/HelpWindow.html
